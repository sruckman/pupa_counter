...
class OutputConfig:
    ...
    overlay_show_unresolved_clusters: bool = False
...
class DetectorConfig:
    ...
    cv_fast_use_rgb_only: bool = True
    cv_max_side_px: int = 1800
    cv_fg_brown_thresh: float = 0.08
    cv_blue_strength_thresh: float = 0.20
    cv_blue_value_thresh: float = 0.40
    cv_open_kernel: int = 2
    cv_close_kernel: int = 2
    cv_min_area_px: int = 40
    cv_suspicious_area_ratio: float = 1.60
    cv_suspicious_major_ratio: float = 1.50
    cv_suspicious_solidity_max: float = 0.78
    cv_filter_angles_deg: List[int] = field(default_factory=lambda: [0, 30, 60, 90, 120, 150])
    cv_filter_major_px_scale: float = 0.95
    cv_filter_minor_px_scale: float = 0.90
    cv_peak_min_distance_minor_scale: float = 0.55
    cv_peak_threshold_percentile: float = 99.84
    cv_local_peak_threshold_percentile: float = 99.2
    cv_max_seed_area_ratio: float = 1.35
    cv_enable_center_only_multi_emit: bool = True
    cv_enable_multithresh_fallback: bool = True
    cv_multithresh_levels: int = 16
    cv_multithresh_min_contrast: float = 0.03
    cv_post_resplit_enabled: bool = True
    cv_post_resplit_min_seed_count: int = 2
    cv_promote_uncertain_confidence_min: float = 0.55
    cv_promote_uncertain_color_score_min: float = 0.52
    cv_promote_uncertain_max_mean_v: float = 180.0
    cv_promote_uncertain_max_mean_lab_b: float = 162.0
    cv_promote_general_uncertain_confidence_min: float = 0.55
    cv_promote_general_uncertain_color_score_min: float = 0.50
    cv_promote_general_uncertain_max_mean_v: float = 175.0
    cv_promote_general_uncertain_max_mean_lab_b: float = 162.0
    cv_global_peak_supplement_enabled: bool = False
    cv_global_peak_exclusion_scale: float = 1.20
    cv_global_peak_max_extra_ratio: float = 0.12
    cv_global_peak_min_brown_score: float = 0.15
    cv_patch_supplement_enabled: bool = False
    cv_patch_supplement_max_extra_ratio: float = 0.20
    cv_patch_supplement_promote_uncertain_confidence_min: float = 0.50
    cv_patch_supplement_promote_uncertain_color_score_min: float = 0.52
    cv_patch_supplement_max_mean_v: float = 175.0
    cv_patch_supplement_max_mean_lab_b: float = 165.0
    cv_promote_pairlike_artifacts_enabled: bool = True
    cv_promote_pairlike_artifacts_color_score_min: float = 0.56
    cv_promote_pairlike_artifacts_max_mean_v: float = 170.0
    cv_promote_pairlike_artifacts_max_mean_lab_b: float = 165.0
    cv_promote_pairlike_artifacts_min_area_px: float = 45.0
    cv_artifact_resplit_enabled: bool = True
    cv_artifact_resplit_color_score_min: float = 0.45
    cv_artifact_resplit_min_local_contrast: float = 15.0
    cv_artifact_resplit_max_mean_v: float = 175.0
    cv_artifact_resplit_max_mean_lab_b: float = 166.0
    cv_artifact_resplit_max_border_touch_ratio: float = 0.25
    cv_artifact_resplit_min_area_ratio: float = 1.60
    cv_artifact_resplit_min_major_ratio: float = 1.35
    cv_large_cluster_resplit_enabled: bool = False
    cv_large_cluster_resplit_color_score_min: float = 0.42
    cv_large_cluster_resplit_min_local_contrast: float = 20.0
    cv_large_cluster_resplit_max_border_touch_ratio: float = 0.10
    cv_large_cluster_resplit_min_area_ratio: float = 4.00
    cv_large_cluster_resplit_min_major_ratio: float = 1.55
    cv_large_pupa_resplit_enabled: bool = True
    cv_large_pupa_resplit_color_score_min: float = 0.48
    cv_large_pupa_resplit_min_local_contrast: float = 10.0
    cv_large_pupa_resplit_max_border_touch_ratio: float = 0.12
    cv_large_pupa_resplit_min_area_ratio: float = 1.45
    cv_large_pupa_resplit_min_major_ratio: float = 1.30
    cv_large_pupa_resplit_min_seed_count: int = 2
    cv_large_pupa_resplit_max_seed_count: int = 3
    cv_large_pupa_resplit_min_aspect_ratio: float = 1.45
    cv_large_pupa_resplit_min_eccentricity: float = 0.72
    cv_large_pupa_resplit_max_area_ratio: float = 2.60
    cv_large_pupa_resplit_min_child_non_artifact_count: int = 2
    cv_large_pupa_resplit_min_child_area_fraction: float = 0.50
    cv_large_pupa_resplit_max_child_area_fraction: float = 1.20
    cv_large_pupa_resplit_max_child_balance_ratio: float = 2.20
    cv_pairlike_resplit_enabled: bool = True
    cv_pairlike_resplit_min_area_ratio: float = 1.55
    cv_pairlike_resplit_max_area_ratio: float = 3.50
    cv_pairlike_resplit_min_minor_px: float = 18.0
    cv_pairlike_resplit_max_eccentricity: float = 0.92
    cv_pairlike_resplit_min_color_score: float = 0.40
    cv_pairlike_resplit_min_local_contrast: float = 8.0
    cv_pairlike_resplit_max_border_touch_ratio: float = 0.08
    cv_pairlike_resplit_max_blue_overlap_ratio: float = 0.03
    cv_pairlike_resplit_max_neighbors_60: int = 4
    cv_pairlike_resplit_min_non_artifact_children: int = 2
    cv_pairlike_resplit_min_child_area_fraction: float = 0.45
    cv_pairlike_resplit_max_child_area_fraction: float = 1.15
    cv_pairlike_resplit_max_child_balance_ratio: float = 2.10
    cv_promote_strong_single_artifacts_enabled: bool = True
    cv_promote_strong_single_artifacts_color_score_min: float = 0.54
    cv_promote_strong_single_artifacts_min_local_contrast: float = 20.0
    cv_promote_strong_single_artifacts_max_mean_v: float = 170.0
    cv_promote_strong_single_artifacts_max_mean_lab_b: float = 162.0
    cv_promote_strong_single_artifacts_max_border_touch_ratio: float = 0.22
    cv_promote_strong_single_artifacts_min_aspect_ratio: float = 1.25
    cv_promote_strong_single_artifacts_min_eccentricity: float = 0.55
    cv_promote_large_single_artifacts_enabled: bool = True
    cv_promote_large_single_artifacts_color_score_min: float = 0.52
    cv_promote_large_single_artifacts_min_local_contrast: float = 20.0
    cv_promote_large_single_artifacts_max_mean_v: float = 175.0
    cv_promote_large_single_artifacts_max_mean_lab_b: float = 162.0
    cv_promote_large_single_artifacts_max_whitespace_ratio: float = 0.40
    cv_promote_large_single_artifacts_max_border_touch_ratio: float = 0.12
    cv_promote_large_single_artifacts_min_aspect_ratio: float = 1.35
    cv_promote_large_single_artifacts_min_eccentricity: float = 0.72
    cv_promote_large_single_artifacts_min_area_px: float = 90.0
    cv_promote_large_single_artifacts_max_area_px: float = 450.0
    cv_suppress_border_split_pupae_enabled: bool = True
    cv_suppress_border_split_pupae_min_seed_count: int = 2
    cv_suppress_border_split_pupae_min_border_touch_ratio: float = 0.18
    cv_suppress_border_split_pupae_max_color_score: float = 0.42
    cv_weak_child_suppress_enabled: bool = True
    cv_weak_child_suppress_max_area_px: float = 176.0
    cv_weak_child_suppress_max_color_score: float = 0.58
    cv_weak_child_suppress_max_local_contrast: float = 35.0
    cv_weak_child_suppress_min_neighbors_60: int = 2
    cv_global_candidate_supplement_enabled: bool = False
    cv_global_candidate_supplement_score_min: float = 2.20
    cv_global_candidate_supplement_max_neighbors_60: int = 2
    cv_global_candidate_supplement_min_distance_px: float = 14.0
    cv_global_candidate_supplement_nms_px: float = 12.0
